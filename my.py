...
#
DB_HOST = '35.183.177.141'
DB_USER = 'hayat'
DB_PASSWORD = 'Upwork123??'
DB_DATABASE = 'clickhr'
...
EMAIL_CREDENTIALS = [
    {'address': 'jobs@y8hr.com', 'password': 'Upwork123??'},  # Add more email addresses and passwords here
]
...
engine = create_engine(
    'mysql+pymysql://hayat:Upwork123??@35.183.177.141/clickhr')
    ...
    while True:
        for email_credentials in EMAIL_CREDENTIALS:
            ...
            try:
                ...
                search_criteria = f'(SINCE 20-Sep-{year} BEFORE 31-Dec-{year})'
